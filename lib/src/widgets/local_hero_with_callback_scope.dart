...
import 'package:local_hero_with_callback/src/widgets/local_hero_with_callback.dart';
import 'package:local_hero_with_callback/src/widgets/local_hero_with_callback_layer.dart';

// ignore_for_file: public_member_api_docs

/// A widget under which you can create [LocalHeroWithCallback] widgets.
class LocalHeroWithCallbackScope extends StatefulWidget {
  /// Creates a [LocalHeroWithCallbackScope].
  /// All local hero animations under this widget, will have the specified
  /// [duration], [curve], and [createRectTween].
  const LocalHeroWithCallbackScope({
    Key? key,
...
class _LocalHeroScopeState extends State<LocalHeroWithCallbackScope>
    with TickerProviderStateMixin
    implements LocalHeroWithCallbackScopeState {
  final Map<Object, _LocalHeroTracker> trackers = <Object, _LocalHeroTracker>{};

  @override
  LocalHeroController track(BuildContext context, LocalHeroWithCallback localHero) {
  ...
  _LocalHeroTracker createTracker(BuildContext context, LocalHeroWithCallback localHero) {
  ...
  @override
  void untrack(LocalHeroWithCallback localHero) {
...
abstract class LocalHeroWithCallbackScopeState {
  LocalHeroController track(BuildContext context, LocalHeroWithCallback localHero);
...
class _InheritedLocalHeroScopeState extends InheritedWidget {
  ...
  final LocalHeroWithCallbackScopeState state;
...
extension BuildContextExtensions on BuildContext {
  ...
  LocalHeroWithCallbackScopeState getLocalHeroScopeState() {
